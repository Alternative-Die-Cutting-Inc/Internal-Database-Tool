...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="Stylesheets/summaryDepartmentFeed.css" />
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                Menu.fixMenu();
                DepartmentFeed.updateDepartmentFeed("DieMaking");
                DepartmentFeed.updateDepartmentFeed("Press");
                DepartmentFeed.updateDepartmentFeed("Stripping");
                DepartmentFeed.updateDepartmentFeed("Gluing");
                DepartmentFeed.updateDepartmentFeed("HandWork");
            });
    ...
    <body style="width: 10000px">
        ...
        <div id="wrapper">
            <div id="contentPane">
                <div id="DieMakingFeed" class="DepartmentFeed">
                    <!-- Feed populated by DepartmentFeed.updateDepartmentFeed() -->
                </div><!-- end of div#DieMakingFeed -->
                <div id="PressFeed" class="DepartmentFeed">
                    <!-- Feed populated by DepartmentFeed.updateDepartmentFeed() -->
                </div><!-- end of div#PressFeed -->
                <div id="StrippingFeed" class="DepartmentFeed">
                    <!-- Feed populated by DepartmentFeed.updateDepartmentFeed() -->
                </div><!-- end of div#StrippingFeed -->
                <div id="GluingFeed" class="DepartmentFeed">
                    <!-- Feed populated by DepartmentFeed.updateDepartmentFeed() -->
                </div><!-- end of div#GluingFeed -->
                <div id="HandWorkFeed" class="DepartmentFeed">
                    <!-- Feed populated by DepartmentFeed.updateDepartmentFeed() -->
                </div><!-- end of div#HandWorkFeed -->
