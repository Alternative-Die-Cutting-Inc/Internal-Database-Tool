...
/*
 * This file takes the html code as a post and turns it into a pdf and emails it
 * to the provided emails.
 */
...
if (isset($_POST["preloadedEmails"]) ||
    ...
    if ($emails[0] != "") {
        ...
        $subject = "Delivery slip for " . $fileName;
        $body = "This is an automated message from Alternative Die Cutting, do not reply to this message. 
    Please contact your sales rep for any inquiries or requests.  <br><br>Attached is the delivery slip for your order.";
        if ($_POST["message"]) {
            $body = str_replace("\n","<br>",$_POST['message']);
        ...
        <body>
         <div id="result">
                <p>The delivery slip has been sent as a PDF to ';
    ...
    //Log email history.
    foreach ($emails as $email) {
        $query = "INSERT INTO Email_Log (DocketNumber, email, customer, type) VALUES ($dn, '$email', '$customer', 'delivery slip')";
        runQuery($query);
    }
}
?>
