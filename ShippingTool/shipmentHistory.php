<?php
/* * *
 * For the given Docket Number, display all the slips that have been made for it.
 * 
 * Allow updates to be made to the slips.
 * 
 * Allow fresh print outs of delivery slips.
 * 
 * Allow auto emailing of slips.
 */
        ...
        <div id="wrapper">
            ...
            <div id="contentPane">
                <div id="slipContainer">
                    <form class="slipPrototype contentContainer" method="post" action="" style="display: none;">
                        ...
                        <input type="button" name="submit" value="Save" onclick="ShipEdit.saveSlip(this.form);"></input>
